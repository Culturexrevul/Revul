...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (currentStep === 3 && !walletAddress) {
      setBlockchainError("Please connect your wallet to register your asset")
      return
    }
  ...
  const handleFileUpload = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (file) {
      if (file.size > 5 * 1024 * 1024) {
        setBlockchainError("File size must not exceed 5MB")
        return
      }
                    ...
                    <div className="flex-1 space-y-3">
                      <div>
                        ...
                        <p className="text-xs text-muted-foreground">
                          Connect your wallet to register this IP on the testnet blockchain for immutable proof of
                          ownership
                        </p>
                      </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  {currentStep === 1 && (
                    <div className="space-y-6">
                      ...
                      <div className="mt-6">
                        <Label htmlFor="assetFile" className="text-sm sm:text-base font-medium">
                        ...
                        <div className="mt-2 flex items-center justify-center w-full">
                          <label className="flex flex-col items-center justify-center w-full h-32 border-2 border-dashed border-border rounded-lg cursor-pointer hover:bg-muted/50 transition-colors">
                            <div className="flex flex-col items-center justify-center pt-5 pb-6">
                              ...
                              <p className="text-xs text-muted-foreground">PNG, JPG, MP3, MP4 up to 5MB</p>
                            </div>
                            <input
                              id="assetFile"
                              type="file"
                        ...
                        {formData.assetFile && (
                          <p className="text-xs text-green-600 mt-2">
                            ✓ {formData.assetFile.name} ({(formData.assetFile.size / 1024 / 1024).toFixed(2)}MB)
                          </p>
                        )}
                      </div>
                  ...
                  {currentStep === 3 && (
                    <div className="space-y-6">
                      ...
                      <div className="flex gap-3">
                        ...
                        <Button
                          type="submit"
                          disabled={currentStep === 3 ? !walletAddress || isLoadingYoutube : isLoadingYoutube}
